  ...
  <div class="tive-gem-container">
    ...
    >
      ...
      <swiper-slide class="omotenashi-card study-guide-card">
        ...
        <div v-if="gemData.socratic_text" class="socratic-feedback-box">
           <p class="socratic-text">{{ gemData.socratic_text }}</p>
        </div>
...
.summary-text { font-size: 0.9rem; line-height: 1.4; color: #444; }
...
.socratic-text { font-size: 1rem; font-style: italic; color: #1a1a1a; font-weight: 500; }
