...
import { Menu, ChevronDown, Sparkles, X, Copy, PenLine, Plus, Mic, Square, Check, Sun, Moon, BookOpen } from 'lucide-react';
              ...
              <AnimatePresence mode="wait">
                {showCardMic ? (
                  <motion.button
                    ...
                    className="w-24 h-24 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center pointer-events-auto shadow-lg"
                    onClick={(e) => {
                      e.stopPropagation();
                      setShowCardMic(false);
                      // Trigger voice input logic here if needed
                    }}
                  >
      ...
      <footer className="p-6 max-w-3xl mx-auto w-full">
        <div className={cn(
          ...
          <input 
            ...
            placeholder={t.promptPlaceholder.replace('{model}', selectedModel)} 
